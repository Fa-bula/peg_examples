# This file was generated from noccur.peg
...
class Grammar(object):
    ...
    def _read_A(self):
        ...
        if address0 is not FAILURE:
            cls0 = type(address0)
            address0.__class__ = type(cls0.__name__ + 'ANodea', (cls0, self._types.ANodea), {})
        if address0 is FAILURE:
            ...
            if address0 is not FAILURE:
                cls1 = type(address0)
                address0.__class__ = type(cls1.__name__ + 'ANodeb', (cls1, self._types.ANodeb), {})
            if address0 is FAILURE:
                self._offset = index1
